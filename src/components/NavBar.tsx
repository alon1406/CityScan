    ...
    >
      <div className="container-fluid">
        <div className="d-flex align-items-center w-100 justify-content-between flex-lg-row flex-column gap-2 gap-lg-0">
            ...
            <div className="cityscan-search-wrap rounded-3 border overflow-hidden w-100">
              <div className="d-flex align-items-center">
                ...
                <input
                  ...
                  placeholder="Street or address — רחוב או כתובת"
                  aria-label="Search by street or address (Hebrew or English)"
          ...
          <div className="d-flex align-items-center gap-4 ms-2 ms-lg-3">
            <Link
              to="/history-reports"
            ...
            <Link
              to="/account"
              className="cityscan-nav-item btn btn-link text-decoration-none d-flex align-items-center justify-content-center rounded-circle p-2"
              style={{
                color: 'var(--cityscan-neutral-600)',
                width: 40,
                height: 40,
              }}
              title="My Account"
